...
class RedactTest(unittest.TestCase):
    ...
    def test_hyphenated_words_ending_in_sk_are_kept(self):
        ...
        for phrase in (
            "ask-before-filing-a-ticket-please",
    ...
    def test_a_memory_cross_reference_survives(self):
        self.assertKept("See [[ask-before-filing-a-ticket]] for the rule about Linear issues.")

    def test_a_filename_survives(self):
        self.assertKept("claude-memory/ask-before-filing-a-ticket.md")
