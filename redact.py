...
_PATTERNS: list[tuple[re.Pattern[str], str]] = [
    ...
    # firing mid-word: without it, ordinary hyphenated prose ("ask-before-filing-a-ticket",
    # "task-queue-retry-backoff-limit") matches and real text is silently destroyed.
